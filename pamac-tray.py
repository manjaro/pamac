...
class Tray:
	def __init__(self):
		...
		self.menuItem.set_image(Gtk.Image.new_from_pixbuf(Gtk.IconTheme.get_default().load_icon('/usr/share/pamac/icons/16x16/apps/pamac-updater.png', 16, 0)))
		...
		self.menuItem.set_image(Gtk.Image.new_from_pixbuf(Gtk.IconTheme.get_default().load_icon('/usr/share/pamac/icons/16x16/apps/pamac.png', 16, 0)))
		self.menuItem.connect('activate', self.execute_manager, self.statusIcon)
		self.menu.append(self.menuItem)
		self.menuItem = Gtk.ImageMenuItem(_('Quit'))
		self.menuItem.set_image(Gtk.Image.new_from_pixbuf(Gtk.IconTheme.get_default().load_icon('/usr/share/pamac/icons/16x16/apps/exit.png', 16, 0)))
